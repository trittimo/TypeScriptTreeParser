...
declare namespace ts {
    ...
    /**
     * @param {string} containingFile - file that contains type reference directive, can be undefined if containing file is unknown.
    ...
    function findBestPatternMatch<T>(values: T[], getPattern: (value: T) => Pattern, candidate: string): T;
    function tryParsePattern(pattern: string): Pattern;
